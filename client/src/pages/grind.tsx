  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="container mx-auto px-0.5 py-4 flex-1">
        <Card className="shadow-md rounded-lg mx-0 transition-all duration-300 hover:shadow-xl transform translate-y-0 border border-sky-100/50 bg-gradient-to-b from-white to-sky-50/30 hover:bg-gradient-to-b hover:from-white hover:to-sky-100/50">
